...
export default function Header() {
  ...
  // Hide header on full-screen layouts (they have their own nav)
  const isFullScreen =
  ...
  return (
    <>
      ...
      >
        <div className="w-full mx-auto px-3 sm:px-5 lg:max-w-7xl lg:px-8 flex items-center justify-between">
          {/* Logo */}
          ...
          <div className="hidden lg:flex items-center gap-3">
                ...
                {isAuthenticated ? (
                  ...
                  <div className="relative" ref={userMenuRef}>
                    ...
                    >
                      ...
                      <span className="text-navy-700 font-medium max-w-[100px] truncate">
                      ...
                      {userMenuOpen && (
                        ...
                        >
                          <div className="p-3 border-b border-navy-50">
                            ...
                            <p className="text-xs text-navy-400 truncate" dir="ltr">
                              {user?.email || ""}
                            </p>
                          </div>
                          <div className="p-1.5">
                            <Link
                              ...
                              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-navy-600 hover:bg-navy-50 transition-all"
                            >
            ...
            <Link href="/loan-application">
              <Button variant={isAuthenticated ? "primary" : "goldOutline"} size="sm">
                قدم طلبك الآن
              </Button>
            </Link>
          </div>
                ...
                <div className="mt-6 space-y-3">
                  {isAuthenticated ? (
                    <>
                      ...
                      <button
                        onClick={handleLogout}
                        className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-red-200 text-red-500 text-sm font-medium hover:bg-red-50 transition-all"
                      >
                        <LogOut className="w-4 h-4" />
                        تسجيل الخروج
                      </button>
